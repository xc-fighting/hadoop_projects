...
public class LanguageModel {
     public static class LanguageMap extends Mapper<LongWritable,Text,Text,Text>{
          int threshold;
          @Override
          ...
          protected void map(LongWritable key,Text value,Context context) throws IOException,InterruptedException{
                  ...
                  //then split the word
                  String[] items=group[0].trim().split("\\s+");
     ...
     public static class LanguageReducer extends Reducer<Text,Text,DBOutputWritable,NullWritable>{
          ...
          public void reduce(Text key,Iterable<Text> values,Context context) throws IOException,InterruptedException{
               ...
               PriorityQueue<info> pq=new PriorityQueue<info>(n,new Comparator<info>() {
